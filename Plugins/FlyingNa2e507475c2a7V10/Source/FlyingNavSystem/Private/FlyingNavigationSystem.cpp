...
FAsyncPathFindingQueryMultiFrame::FAsyncPathFindingQueryMultiFrame()
	: QueryID(INVALID_NAVQUERYID),
	  Mode(EPathFindingMode::Regular)
{
}

FAsyncPathFindingQueryMultiFrame::FAsyncPathFindingQueryMultiFrame(const UObject* InOwner,
...
FAsyncPathFindingQueryMultiFrame::FAsyncPathFindingQueryMultiFrame(const FPathFindingQuery& Query,
                                                                   const FNavPathQueryDelegate& Delegate,
...
void UFlyingNavigationSystem::DispatchAsyncQueriesResultsMultiFrame(
	const TArray<FAsyncPathFindingQueryMultiFrame>& PathFindingQueries)
{
	if (PathFindingQueries.Num() > 0)
	{
