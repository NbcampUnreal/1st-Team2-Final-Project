...
// Dummy generated inline include for UE4
#define UE_INLINE_GENERATED_CPP_BY_NAME(...) "CoreMinimal.h"
#endif // UE5
...
namespace FlyingNavSystem
{
	...
	*/
	...
	{
		// Engine plugins make this cast, but I'm not convinced it's not UB due to strict aliasing.
